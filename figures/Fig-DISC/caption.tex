...
\textbf{(F)} Mean ATAC-seq coverage (reads per million) in gene bodies of OFF-state homeobox genes and length-matched non-homeobox genes are shown. Student's t-test p-value is $<$ 10e-9. 
}